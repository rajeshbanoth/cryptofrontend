          ...
          <div className="row">
            <div className="col-md-12">
              <div className="markets-pair-list">
                <Tabs defaultActiveKey="inr">
                  <Tab eventKey="inr" title="INR">
                    <MarketListTable type={"inr"} />
                  </Tab>
                  <Tab eventKey="btc" title="BTC">
                    <MarketListTable type={"btc"} />
                  </Tab>
                  <Tab eventKey="usdt" title="USDT">
                    <MarketListTable type={"usd"} />
                  </Tab>
                  <Tab eventKey="mcoin" title="MCOIN">
                    <MarketListTable type={"usd"} coin="mcoin" />
                  </Tab>
                </Tabs>
